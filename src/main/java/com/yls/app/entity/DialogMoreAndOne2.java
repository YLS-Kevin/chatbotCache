...
/**
 * @author huangsy
 * @date 2018年5月31日下午6:45:12
 */
public class DialogMoreAndOne2 {
	...
	private String mul_dialog_type;

	private String cid_m_id_dt;
	
	private String is_front_call;
	
	private int is_contain_kw;
	...
	public String getAwordnum() {
		return awordnum;
	}

	public void setAwordnum(String awordnum) {
	...
	public String getDas_atype() {
		return das_atype;
	}

	public void setDas_atype(String das_atype) {
		this.das_atype = das_atype;
	}
	...
	public String getMul_dialog_type() {
		return mul_dialog_type;
	}

	public void setMul_dialog_type(String mul_dialog_type) {
		this.mul_dialog_type = mul_dialog_type;
	}

	public String getCid_m_id_dt() {
		return cid_m_id_dt;
	}

	public void setCid_m_id_dt(String cid_m_id_dt) {
		this.cid_m_id_dt = cid_m_id_dt;
	}

	public String getIs_front_call() {
		return is_front_call;
	}

	public void setIs_front_call(String is_front_call) {
		this.is_front_call = is_front_call;
	}

	public int getIs_contain_kw() {
		return is_contain_kw;
	}

	public void setIs_contain_kw(int is_contain_kw) {
