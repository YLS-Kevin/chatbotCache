package com.yls.app.repository.impl;
...
import com.yls.app.repository.RedisApi;
...
public class RedisApiImpl implements RedisApi {
	...
	private static Logger logger = Logger.getLogger(RedisApiImpl.class);
	...
	/*	  *//**
			 ...
			 * @return
			 *//*
				 * public Long zadd(String key,Map<Double, String>
				 * scoreMembers){ Jedis jedis = null; Long res = null; try {
				 * jedis = pool.getResource(); res = jedis.zadd(key,
				 * scoreMembers); } catch (Exception e) {
				 * pool.returnBrokenResource(jedis); logger.error(e,e); }
				 * finally { returnResource(pool, jedis); } return res; }
				 */
	...
	/* (non-Javadoc)
	 * @see com.yls.app.repository.RedisApi#del(java.lang.String)
	 */
	@Override
